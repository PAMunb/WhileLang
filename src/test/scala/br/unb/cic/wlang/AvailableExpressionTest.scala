...
*/
  ...
  val s3 = While(Condition(GT(Var("y"), Add(Var("a"), Var("b"))), 3), s2)
...
//   While(Condition(GT(Var("y"), Add(Var("a"), Var("b")))), s2)
  ...
  test("Test case for available expression") {
    ...
    // -> asserts 2, 3 e 4 estão falhando
    // assert(in(2) == Set(Add(Var("a"), Var("b"))))
    // assert(out(2) == Set(Add(Var("a"), Var("b")), Mult(Var("a"), Var("b"))))

    // assert(in(3) == Set(Add(Var("a"), Var("b"))))
    // assert(out(3) == Set(Add(Var("a"), Var("b")), Mult(Var("a"), Var("b"))))
  
    // assert(in(4) == Set(Add(Var("a"), Var("b")), Mult(Var("a"), Var("b"))))
